![MatEl Dashboard Preview](https://raw.githubusercontent.com/MosesDevone/MataElang-Network-Monitoring/main/preview.jpeg)
...
### 🔐 6. Enterprise-Grade Security & Identity
*   **JWT Authentication**: Secure access control using *JSON Web Tokens* with configurable expiry.
*   **User Profile Management**: Personalize your identity with custom **Bio** and **Avatar URL** support.
*   **Account Recovery System**: Secure workflow for **Forgot Password** (token-based reset) and **Forgot Username** retrieval via verified email.
